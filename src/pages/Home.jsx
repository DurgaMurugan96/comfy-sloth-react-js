...
function Home() {
    ...
    return (
        <div className="HomePage">
            <div className=" container container_Home d-flex">
                <div className='d-flex'>
                    <div className='Home_content'>
                        <h1>Design Your<br />
                            Comfort Zone</h1>
                        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. <br />Iusto, at sed omnis corporis doloremque possimus velit! <br /> Repudiandae nisi odit, aperiam odio ducimus, obcaecati <br />libero et quia tempora excepturi quis alias?</p>
                    ...
                    <div className='Home_picture'>
                        ...
                        <img src="https://react-course-comfy-sloth-store.netlify.app/static/media/hero-bcg.a876f19f6786a3aca992.jpeg" className="Home_pic" alt="alternative_text" />
                        <img src="https://react-course-comfy-sloth-store.netlify.app/static/media/hero-bcg-2.789918645915c8acb36f.jpeg" className="Home_pic2" alt="alternative_text" />
            ...
            <section className="Home_page">
                <div className="section_center">
                    ...
                    <div className="content_HomePage">
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Placeat sint <br />unde quaerat ratione soluta veniam provident adipisci cumque eveniet <br />tempore?</p>
