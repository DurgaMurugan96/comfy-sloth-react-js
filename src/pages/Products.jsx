                    ...
                    <div className="fixed-column">
                        <div className="control-form ">
                            <Searchbar className="input_search_style"
                                handleSearchInputChange={updateFilter}
                                search={search} />
...
// // return (
// //         <div>
// //             {/* Render filter inputs and UI here */}
// //             {/* Render products using filtered_products state */}
// //             {/* Implement functionality to update filters based on user interactions */}
// //             {/* Implement functionality to clear filters */}
// //         </div>
// //     );
// // }